CREATE DATABASE Aadhaar_Centre;
use Aadhaar_Centre;

CREATE TABLE Aadhaar_Info__(
    id INT PRIMARY KEY,
    ...
    isSignatureValid BOOLEAN DEFAULT TRUE,
    mail_id VARCHAR(50) UNIQUE NOT NULL,
    district_code BIGINT NOT NULL,
    enrollment_no BIGINT UNIQUE NOT NULL,
    relationship_status VARCHAR(20) CHECK (relationship_status IN ('Single', 'Married')),
    state_name VARCHAR(50) NOT NULL
);


INSERT INTO Aadhaar_Info__ VALUES 
